...
public class SettlementData {
    ...
    public SettlementData(String pointCode, double initialElevation, double previousElevation,
    ...
    public void calculateDerivedValues(LocalDate previousDate, LocalDate currentDate, int customDays) {
        // 本期变化 = 本期高程 - 前期高程
        this.currentChange = this.currentElevation - this.previousElevation;

        // 累计变化 = 本期高程 - 初始高程
        this.cumulativeChange = this.currentElevation - this.initialElevation;
