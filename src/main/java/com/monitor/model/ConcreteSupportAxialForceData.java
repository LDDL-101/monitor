 ...
 * 砼支撑轴力数据模型类
 */
public class ConcreteSupportAxialForceData implements Serializable {
    ...
    private double historicalCumulative; // 历史累积量(KN)
    private LocalDate measurementDate;   // 测量日期

    /**
     * 默认构造函数
     */
    public ConcreteSupportAxialForceData() {
    }

    /**
     * 带参数的构造函数
     */
    public ConcreteSupportAxialForceData(String pointCode, double previousForce,
